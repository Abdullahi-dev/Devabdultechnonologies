...
import { Cloud, ChevronRight, Server, Database, Shield, Zap, RefreshCw } from "lucide-react";
import { Contact } from "../../components/Contact";

export function CloudInfrastructure() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Cloud Infrastructure | Devabdultechnologies";
  }, []);

  const cloudFeatures = [
    { icon: Server, title: "Scalable Compute", desc: "Auto-scaling server instances to handle varying workloads efficiently." },
    { icon: Database, title: "Managed Databases", desc: "Highly available, distributed database systems for robust data storage." },
    { icon: Shield, title: "Network Security", desc: "Virtual private clouds, firewalls, and DDoS protection." },
    { icon: Zap, title: "Edge Computing", desc: "Content delivery networks (CDNs) for low-latency global access." },
    { icon: RefreshCw, title: "Disaster Recovery", desc: "Automated backups and multi-region failover strategies." },
    { icon: Cloud, title: "Serverless Architecture", desc: "Event-driven computing that scales automatically without server management." }
  ];
        ...
        <div className="max-w-[1440px] mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight tracking-tight">
              Enterprise <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-blue to-white">Cloud Infrastructure</span>
            </h1>
            <p className="text-xl text-white/60 mb-10 leading-relaxed">
              Our cloud architecture ensures global scalability, reliability, and high availability across AWS, Google Cloud, and Azure.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[1440px] mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-bg-dark/80 mb-10">
              Partner with Devabdultechnologies to build resilient cloud architectures.
            </p>
