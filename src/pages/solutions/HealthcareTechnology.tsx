...
import { HeartPulse, ChevronRight, Activity, ShieldPlus, Stethoscope, Database, Users } from "lucide-react";
import { Contact } from "../../components/Contact";

export function HealthcareTechnology() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Healthcare Technology Solutions | Devabdultechnologies";
  }, []);

  const systems = [
    { icon: Database, title: "Hospital Management Systems", desc: "Comprehensive platforms for managing hospital operations, billing, and staff." },
    { icon: Activity, title: "Telemedicine Platforms", desc: "Secure video consultation and remote patient monitoring systems." },
    { icon: ShieldPlus, title: "Electronic Health Records", desc: "HIPAA-compliant EHR systems for secure patient data management." },
    { icon: Stethoscope, title: "Medical AI Systems", desc: "AI-powered diagnostic assistance and predictive health analytics." },
    { icon: Users, title: "Patient Portals", desc: "Self-service portals for appointment booking, test results, and communication." }
  ];
        ...
        <div className="max-w-[1440px] mx-auto px-6 text-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight tracking-tight">
              Digital Platforms for <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-blue to-accent-purple">Modern Healthcare</span>
            </h1>
            <p className="text-xl text-white/60 mb-10 leading-relaxed">
              We build secure, compliant, and scalable digital platforms for hospitals, clinics, telemedicine providers, and healthcare data management.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[1440px] mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-bg-dark/80 mb-10">
              Partner with Devabdultechnologies to build secure and scalable medical platforms.
            </p>
